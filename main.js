                    ...
                    if (local_price) {
                        ...
                        for (const [shop_name, price] of price_map) {
                            if (Number(price) < Number(local_price) ) {
                                ...
                                await secondPage.locator('xpath=//*[@id="seller-content"]/ui-view/div[3]/ui-view[2]/div[1]/div[2]/div[3]/div/div/div/div/div[3]/div[2]/div/div/div/div[3]/span/input').fill((Number(price) - 10).toString());
